        ...
        const returnData = ()=>{
            return new Promise((response,reject)=>{
                ...
                var postData = qs.stringify({
                    'ControlGroupSearch$SearchMainSearchView$RadioButtonMarketStructure': (!body.dataVolta?'OneWay':'RoundTrip'),
                    'origin1': /*'Belo+Horizonte+-+Confins+(CNF)'*/body.origem,
                    'ControlGroupSearch$SearchMainSearchView$TextBoxMarketOrigin1': /*'Belo+Horizonte+-+Confins+(CNF)'*/body.origem,
                    //'ControlGroupSearch$SearchMainSearchView$CheckBoxUseMacOrigin1': '',
                    'hdfSearchCodeDeparture1': '1N',
                    'originIata1': body.origem,
                    ...
                    //'promocode': '',
                    //'orgcode': '',
                    'destination1': /*'São+Paulo+-+Congonhas+(CGH)'*/body.destino,
                    'ControlGroupSearch$SearchMainSearchView$TextBoxMarketDestination1':/* 'São+Paulo+-+Congonhas+(CGH)'*/body.destino,
                    //'ControlGroupSearch$SearchMainSearchView$CheckBoxUseMacDestination1': '',
                    'hdfSearchCodeArrival1': '1N',
                    'destinationIata1': body.destino,
                    ...
                    'departure1': body.dataIda,
                    'ControlGroupSearch$SearchMainSearchView$DropDownListMarketDay1': moment(departure).format('DD'),
                    'ControlGroupSearch$SearchMainSearchView$DropDownListMarketMonth1': moment(departure).format('YYYY/MM'),
                    'ControlGroupSearch$SearchMainSearchView$DropDownListPassengerType_ADT': body.adultos,
                    'ControlGroupSearch$SearchMainSearchView$DropDownListPassengerType_CHD': body.criancas,
                    'ControlGroupSearch$SearchMainSearchView$DropDownListPassengerType_INFANT': body.bebes,
